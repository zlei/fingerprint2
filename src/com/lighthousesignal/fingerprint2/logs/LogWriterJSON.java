...
public class LogWriterJSON {
        ...
        private static LogWriterJSON sInstance;

        public static LogWriterJSON instance() {
                return sInstance == null ? sInstance = new LogWriterJSON() : sInstance;
        }
        ...
        public static void delete(String file) {
                new File(LogWriterJSON.APPEND_PATH + file).delete();
        }
